    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <ul class="list-unstyled">
                <li><a href="http://www.hung-art.hu">Fine Arts in Hungary<br /><i>hung-art.hu</i></a></li>
...
{literal}
    <script>
        ...
        ga('create', 'UA-23717600-5', 'blackworks.org');
        ga('send', 'pageview');
    ...
    <script type="text/javascript"> 
      ...
      (function() {
        var u=(("https:" == document.location.protocol) ? "https" : "http") + "://analytics.blackworks.org//";
    ...
    <noscript><p><img src="http://analytics.blackworks.org/piwik.php?idsite=1" style="border:0" alt="" /></p></noscript>
    <!-- End Piwik Code -->
