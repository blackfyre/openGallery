...
//some modifications to simplify the usage
...
define('CACHE_DIR_NAME',		'/cache/img/');
...
// images must start with '/' <- This has been removed to produce an image url without double '/'
